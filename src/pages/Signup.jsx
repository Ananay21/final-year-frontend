        ...
        <div className='bg-black w-1/2 h-[600px] max-sm:w-full flex items-center justify-center rounded-xl mx-3 flex-col'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-3 text-white w-2/3 px-4 max-sm:w-4/5'>
                <div className='flex flex-col gap-1'>
                    ...
                    <input type="text" name='userName' className='bg-white text-black pl-3 py-2 rounded-lg' {...register("userName",{required:{value:true,message:"Cannot be empty"},minLength:{value:5,message:"Minimum length should be 5"}})}/>
          ...
          <a href="/login" className='text-[#d4be81] mt-10'>Already a user? Try logging in</a>
        </div>
